...
//	machine, _ := domain.NewMachine("foo", domain.P, nil, nil)
//	repo := setupRepo()
//	repo.reset()
//	defer repo.reset()
...
//	machine, _ := domain.NewMachine("original", domain.P, nil, nil)
//	repo := setupRepo()
//	repo.reset()
//	defer repo.reset()
//	repo.Store(machine)
...
//	defer repo.reset()
//	for i := 0; i < 10; i++ {
//		machine, _ = domain.NewMachine(strconv.Itoa(i), domain.P, nil, nil)
//		repo.Store(machine)
//	}
